                  ...
                  <div class="row">
                    <div class="col-md">
                      <div class="displaynameDiv">
                        <label for="displaynameinput" class="signuplabelsleft">
                          Display Name
                        </label>
                        <input
                          maxLength={10}
                      ...
                      <div class="birthdayDiv">
                        <label for="birthday" class="signuplabelsleft">
                          Birth Date
                        </label>
                        <input
                          type="date"
                      ...
                      <div class="sexDiv">
                        <label for="sex" class="signuplabelsleft">
                          Sex
                        </label>
                        <RadioGroup
                        ...
                        >
                          <div class="malesexdivsub">
                            <FormControlLabel
                              ...
                              id="Male"
                            />
                            <label for="Male" class="sexlabels">
                              Male
                            </label>
                          </div>
                          ...
                          <div class="femalesexdivsub">
                            <FormControlLabel
                              ...
                              id="Female"
                            />
                            <label for="Female" class="sexlabels">
                              Female
                            </label>
                          </div>
                    ...
                    <div class="col-md">
                      <div class="emailDiv">
                        <label for="Email" class="signuplabelsleft">
                          Email
                        </label>
                        <input
                      ...
                      <div class="passwordDiv">
                        <label for="password" class="signuplabelsleft">
                          Password
                        </label>{" "}
                        <input
                          maxLength={12}
                      ...
                      <div class="confirmpasswordDiv">
                        <label for="ConfirmPassword" class="signuplabelsleft">
                          Confirm Password
                        </label>{" "}
                        <input
                          maxLength={12}
